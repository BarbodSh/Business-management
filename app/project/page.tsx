      ...
      <div className="container">
        <div className="grid grid-cols-12 justify-between content-center gap-5 mt-10">
          ...
          <div className="col-span-8 w-full">
            <div className="bg-white/30 backdrop-blur-sm rounded-lg mb-5 flex justify-between items-center p-3 font-bold text-xl">
              <span>Title: Project</span>
              <span>Members: 5</span>
              <span>Tasks: 5</span>
              <button className="rounded-lg p-1 border-1 w-25 cursor-pointer text-center border-green-500 hover:text-white hover:bg-green-500 transition duration-200 ease-in">
                Edit
              </button>
            </div>
            <div className="bg-white/30 backdrop-blur-sm rounded-lg h-50"></div>
          </div>
        </div>
      </div>
    </section>
